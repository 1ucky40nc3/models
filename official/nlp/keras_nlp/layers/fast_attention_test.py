...
# Copied from:
# https://github.com/google-research/google-research/blob/master/performer/fast_attention/tensorflow/fast_attention_test.py
...
import official.nlp.keras_nlp.layers.fast_attention as fast_attention
